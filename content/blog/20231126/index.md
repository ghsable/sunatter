...
題して「出力結果から言えること **だけ** を並べてみる」です。内容は「[参照先のアドレスを確認してみる](#参照先のアドレスを確認してみる)」とします。

```text
⚠️
- 基本的な内容だけを取り扱います。
- あくまで出力結果から言えることだけを並べる試みです。
